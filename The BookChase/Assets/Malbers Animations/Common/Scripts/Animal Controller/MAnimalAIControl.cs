    ...
    public class MAnimalAIControl : MonoBehaviour, IAIControl, IAITarget
    {
      ...
      //  public bool NullDestination => DestinationPosition == NullVector;
        ...
        private void Arrive_Destination()
        {
            ...
            IsWayPoint?.TargetArrived(animal.gameObject);                          //Send to the Waypoint that the we have Arrived
            ...
            if (IsWayPoint != null)     //If we have arrived to a WayPoint
            {
                ...
                if (AutoInteract) IsWayPoint.TargetArrived(animal.gameObject);              //Call the method that the Target has arrived to the destination
